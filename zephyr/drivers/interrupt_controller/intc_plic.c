 ...
 */
// test
volatile int p_plic_IRQ;
volatile int p_plic_IRQ1;
volatile int p_plic_IRQ2;
...
static int plic_init(const struct device *dev)
{
	...
	//testing
	p_plic_IRQ = PLIC_IRQS;
	p_plic_IRQ1 = CONFIG_NUM_IRQS;
	p_plic_IRQ2 = CONFIG_2ND_LVL_ISR_TBL_OFFSET;
